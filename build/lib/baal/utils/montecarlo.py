...
class Markov_Chain_Monte_Carlo:
    ...
    def run(self, T, name=None, prog_frequency=100):
        # Variable 'adjust' has been thrown in to let us generate data on the -180 to 180 support set
        # otherwise it'd try and convert and I'm not sure if tha would keep it in the same domain or not..
